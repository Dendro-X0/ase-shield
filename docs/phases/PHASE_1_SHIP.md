...
Push tag `v*` to trigger [.github/workflows/release.yml](../../.github/workflows/release.yml). Release notes: [docs/releases/v1.0.0-beta.3.md](../releases/v1.0.0-beta.3.md). Local gate: `pnpm verify:release`.
